        ...
        <form id="login-form">
            <div class="w-full">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="user-email" name="UserEamil"
                           class="input-field focus:ring-2 focus:ring-mainGreen2 focus:outline-none invalid:ring-2 invalid:ring-red-400"
                ...
                <div class="mb-5">
                    <div class="mb-6" id="member-agree-select">
                        <input type="checkbox" name="agreeAll" id="member-agree-all" class="mb-3 font-bold"/>
                        모두 동의하기
                        <br/>
                        <input type="checkbox" name="agree" class="mb-3"/>
                        이용약관, 개인정보처리방침에 동의합니다.<br/>
                        <input type="checkbox" name="agree" class="mb-3"/>
                        (선택) 소식 및 정보 수신에 동의합니다.
                    </div>
                    <button type="button" name="submit" id="user-submit-button"
